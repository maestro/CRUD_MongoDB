<?
$mongo = new Mongo(); // Inicializo la clase de Mongo
$database = $mongo->selectDB("prueba"); //Selecciono la Base de Datos, si no existe la crea
$estudiante = $database->selectCollection('estudiante'); // Selecciono la coleccion (tabla), y la asigno a un objeto
...
?>
<table>
<tr><td><a href="index.php?accion=agregar">Nuevo</a></td></tr>
</table>
<br />
<table border="1">
<tr>
...
<td width="97px"><a href="index.php?accion=editar&id=<?php echo $row['_id'] ?>">Editar</a></td>
<td width="97px"><a href="index.php?accion=eliminar&id=<?php echo $row['_id'] ?>">Eliminar</a></td>
</tr>
<?
endforeach;
?>
...
if($accion == 'editar') // Si la accion es editar
{
	if(isset($_POST['submit']))
	{
		...
		echo"<script language='javascript'>window.location='index.php'</script>"; //redirecciono
	}
